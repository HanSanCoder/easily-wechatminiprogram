module.exports = { //物业小区 taskcommunity
	...
	USER_FIELDS: [
		...
		{ mark: 'card', title: '学号', type: 'text',len:8, must: true },
		// { mark: 'card_img', title: '身份证正反面', type: 'image', len: 2, must: true },
		{ mark: 'house', title: '学院', type: 'text', must: true },
	...
	TASK_NAME: '报事报修',
	TASK_TYPE: ['蓝屏死机', '无法启动', '运行缓慢', '显示异常', '声音问题', '电源问题', '病毒感染', '服务投诉', '热心建议', '其他事项'],
	TASK_LEVEL: ['紧急', '一般', '次要'],
	TASK_FIELDS: [
